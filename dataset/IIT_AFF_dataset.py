...
class IIT_AFF_Dataset(torch.utils.data.Dataset):
    CLASSES_NAME = (
        "__background__ ",
        "bowl",
        "tvm",
    ...
    def __init__(self,root_dir,resize_size=[512,512],split='train',use_difficult=False,is_train = True, augment = None):
        self.root=root_dir
        ...
        self.name2id=dict(zip(IIT_AFF_Dataset.CLASSES_NAME,range(len(IIT_AFF_Dataset.CLASSES_NAME))))
